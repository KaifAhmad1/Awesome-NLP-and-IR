...
- [System Level Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#system-level-optimization)
  - [Inference Engine Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#inference-engine-optimization)
      - [Graph and Operator Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#graph-and-operator-optimization)
        - [Runtime Profiling](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#runtime-profiling)
        - [Attention Operator Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#attention-operator-optimization)
        - [Linear Operator Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#linear-operator-optimization)
      - [Decoding Strategies](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#decoding-strategies)
        - [Autoregressive Decoding](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#autoregressive-decoding)
        - [Speculative Decoding](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#speculative-decoding)
        - [Lookahead Decoding](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#lookahead-decoding)
        - [Multitoken Prediction](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#multi-token-prediction)
      - [Graph-Level Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#graph-level-optimization)
        - [Kernel Fusion](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#kernel-fusion)
        - [Layer Fusion](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#layer-fusion)
