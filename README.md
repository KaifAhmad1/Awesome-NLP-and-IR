...
- [Model Level Optimization](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#model-level-optimization)
  - [Efficient Structure Design](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#efficient-structure-design)
      - [Sparse Mixture of Experts](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#sparse-mixture-of-experts)
      - [Multiscale Transformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#multiscale-transformer)
      - [Mixture of Denoisers](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#mixture-of-denoisers)
      - [Sparseformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#sparseformer)
      - [Sparse Switch Transformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#sparse-switch-transformer)
  - [Efficient Attention Mechanisms](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#efficient-attention-mechanisms)
      - [Perceiver](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#perceiver)
      - [Perceiver AR](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#perceiver-ar)
      - [Perceiver IO](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#perceiver-io)
      - [Reformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#reformer)
      - [Linformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#linformer)
      - [Longformer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#longformer)
      - [Performer](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#performer)
      - [Big Bird](LLM-Efficiency-and-Inference-Optimization/LLM-Efficiency.md#big-bird)
